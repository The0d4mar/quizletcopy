...
import { FolderIcon, IdCardLanyard, Languages, Search } from "lucide-react";
              ...
              {results.map((result) => (
                ...
                >
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="block max-w-[280px] truncate text-sm text-white/60">{result.subtitle}</span>
                  </span>
                </Link>
              ))}
            </div>
